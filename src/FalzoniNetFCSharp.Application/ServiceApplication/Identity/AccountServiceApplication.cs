...
{
    public class AccountServiceApplication : IDisposable
    {
        #region Attributes
        ...
        #region Services
        public IdentityResultCodeDTO AddExternalLogin(string userId, string externalAccessToken)
        {
        ...
        public IdentityResultCodeDTO ChangePassword(ChangePasswordBindingDTO changePasswordBindingDTO)
        {
        ...
        public IdentityResultCodeDTO ResetPassword(ResetPasswordDTO resetPasswordDTO)
        {
        ...
        public void SendEmailResetPassowrd(ConfirmEmailCodeDTO confirmEmailCodeDTO)
        {
        ...
        public ConfirmEmailCodeDTO GeneratePasswordResetToken(string email)
        {
        ...
        public IdentityResultCodeDTO RemoveExternalLogin(string userId, string loginProvider, string loginKey)
        {
        ...
        public async Task<IdentityResultCodeDTO> AddExternalLoginAsync(string userId, string externalAccessToken)
        {
            AuthenticationTicket ticket = AccessTokenFormat.Unprotect(externalAccessToken);
        ...
        public async Task<IdentityResultCodeDTO> ChangePasswordAsync(ChangePasswordBindingDTO changePasswordBindingDTO)
        {
        ...
        public async Task<IdentityResultCodeDTO> ResetPasswordAsync(ResetPasswordDTO resetPasswordDTO)
        {
        ...
        public async Task SendEmailResetPassowrdAsync(ConfirmEmailCodeDTO confirmEmailCodeDTO)
        {
        ...
        public async Task<ConfirmEmailCodeDTO> GeneratePasswordResetTokenAsync(string email)
        {
        ...
        public async Task<IdentityResultCodeDTO> RemoveExternalLoginAsync(string userId, string loginProvider, string loginKey)
        {
            IdentityResult result;
